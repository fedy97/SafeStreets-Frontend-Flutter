...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \caption[\textit{User} Sign Up]{shows an example of the registration page of SafeStreet}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.4]{assets/login.png}\\[1.6 cm]
        \caption[\textit{User} Login]{shows an example of the login page of SafeStreet}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.4]{assets/home.png}\\[1.6 cm]
        \caption[\textit{User} Home]{shows the homepage of the app after the login phase, displaying for example the map with all the violation reported}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.4]{assets/viewreport.png}\\[1.6 cm]
        \caption[View Report]{shows a violation uploaded by a user}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.4]{assets/report.png}\\[1.6 cm]
        \caption[Report a violation]{shows the report form, same for both citizens and authorities}
    \end{figure}
