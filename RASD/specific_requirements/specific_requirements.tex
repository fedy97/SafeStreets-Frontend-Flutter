    ...
    \newline
        ...
        \subsection{Use Case Diagrams}\label{subsec:Use-case-diagram}
                \begin{figure}
                    ...
                    \caption[Citizen Use Case Diagram]{Citizen Use Case Diagram}
                \end{figure}
                \begin{figure}
                    \includegraphics[scale = 1.5]{assets/authorityUC.png}\\[1.6 cm]
                    \caption[Authority Use Case Diagram]{Authority Use Case Diagram}
                \end{figure}
                \begin{figure}
                    \includegraphics[scale = 1.5]{assets/safeStreetUC.png}\\[1.6 cm]
                    \caption[SafeStreet Use Case Diagram]{SafeSteet Use Case Diagram}
                \end{figure}
                \newpage
