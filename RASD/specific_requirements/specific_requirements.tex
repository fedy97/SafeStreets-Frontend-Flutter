...
\begin{document}
    ...
    \newline
            ...
            \subsection{Use Case Diagrams}\label{subsec:Use-case-diagram}
                \begin{center}
                    \includegraphics[scale = 0.8]{assets/citizenUC.png}\\[1.6 cm]
                \end{center}
                \begin{center}
                    \includegraphics[scale = 0.8]{assets/authorityUC.png}\\[1.6 cm]
                \end{center}
                \begin{center}
                    \includegraphics[scale = 0.8]{assets/safeStreetUC.png}\\[1.6 cm]
                \end{center}
                \newpage
