...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \assumption{5}Authority can receive consent to user data access only through a service it does and can use the data only for that specific service.
        \assumption{6}authorities upload information about incidents that corresponds to real data.
    \end{enumerate}
