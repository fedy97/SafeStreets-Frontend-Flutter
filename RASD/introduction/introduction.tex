...
%%%%%%%%%
 \begin{center}
        \begin{longtable}{| p{.65\linewidth} | p{.20\linewidth} | p{.30}\linewidth}
            ...
            Machine stores information (users and pictures with data) on the database & N & M\\ \hline
            ...
            The machine gets the information about the accidents from the local municipality & Y & M\\ \hline
            The machine crosses information about accidents and violations to submit possible interventions, that can be both considered or not & Y & M\\ \hline
        \end{longtable}
    \end{center}
%%%%%%%%%
