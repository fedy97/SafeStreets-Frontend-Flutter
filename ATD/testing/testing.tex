...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.5]{assets/web_page_error.png}\\
        \caption[Web page error, \textit{Error}]{Web page error}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.7]{assets/smartphone_error.png}\\
        \caption[SMartphoone error, \textit{Error}]{Smartphone error}
    \end{figure}
    \begin{figure}[H]
        \centering
