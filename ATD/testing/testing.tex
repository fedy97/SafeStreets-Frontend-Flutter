...
\begin{document}
   ...
   %%todo ******** TABELLA *********
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.3]{assets/database_user_report.png}\\
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.6]{assets/report_upload_error.png}\\
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.7]{assets/database_user_report.png}\\
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.3]{assets/web_page_error.png}\\
        \caption[Web page error]{Web page error.}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.6]{assets/smartphone_error.png}\\
        \caption[Smartphone error]{Smartphone error.}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.6]{assets/iOS_simulator_error.png}\\
