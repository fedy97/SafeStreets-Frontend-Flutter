...
\begin{document}
    ...
    We think that this issue is related to the GPS connection and is the cause of the most of the fail in the test that will be presented in the next chapter.
