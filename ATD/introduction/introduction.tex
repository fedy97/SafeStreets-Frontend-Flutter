...
\begin{document}
    ...
    The source code, as well as the RASD, DD and ITD documents, and every other document concerning the project, can be found on github at the following repository:
    \href{https://github.com/gianfi12/AbboAccordiBonetti}
