...
\begin{document}
    ...
    \subfile{implemented_requirements/implemented_requirements.tex}
    \subfile{development_frameworks/development_frameworks.tex}
    \subfile{Structure_of_the_source_code/Structure_of_the_source_code.tex}
    \subfile{testing/testing.tex}
    \subfile{installation_instructions/installation_instructions.tex}
