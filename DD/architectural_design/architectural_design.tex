...
\begin{document}
    ...
    \begin{itemize}
        \item     Function queryDb: this method is used both by UnsafeAreaManager and StatisticsManager in order to cross all the information necessary to do their job.
